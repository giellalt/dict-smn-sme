# Dictionary for smn — sme

This repository contains source files for a dictionary from Inari Sámi to North Sámi. The content is licensed under the CC-BY-4.0 license.
